          ...
          <div style={{
            ...
            <div style={{ padding: 18, overflowY: 'auto', maxHeight: '60vh', lineHeight: 1.55 }}>
              ...
              <ul>
                ...
                <li><strong>Payment &amp; refunds:</strong> Prices excl. GST unless stated; refunds limited to non-delivery or breach.</li>
                <li><strong>IP &amp; use:</strong> Materials licensed for internal use only.</li>
                <li><strong>Law &amp; disputes:</strong> Queensland law; mediation before litigation.</li>
              </ul>
            </div>

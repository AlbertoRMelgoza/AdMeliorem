...
export default function AboutPage() {
  ...
  // Safer grid (no overflow on small screens)
  ...
  return (
    <section style={wrap} className="about">
      ...
      {/* Responsive tweaks (plain <style>, no styled-jsx needed) */}
      <style>{`
        .about :is(p, li, blockquote) { overflow-wrap: anywhere; hyphens: auto; }
        @media (max-width: 640px) {
          .about-grid { grid-template-columns: 1fr; }
          .cta-strip p { font-size: 15px; line-height: 1.35; }
          .about h1 { font-size: 20px; line-height: 1.3; }
        }
      `}</style>
    </section>
  );

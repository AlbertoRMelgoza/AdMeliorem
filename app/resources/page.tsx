export default function Page() {
  const linkStyle = { color: "#f1c40f", textDecoration: "underline" };
  ...
  const policies = [
    ...
    { title: "Code of Ethics", blurb: "Critical for guiding behaviour and decision making." }
  ];
  ...
  return (
    <main style={{ maxWidth: 960, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <section style={{ border: "1px solid #222", borderRadius: 12, padding: 16, marginBottom: 16 }}>
        <h2 style={{ margin: 0, fontSize: 20 }}>FAQs (ISOs and psychosocial risk)</h2>
      ...
      <section style={{ border: "1px solid #222", borderRadius: 12, padding: 16, marginBottom: 16 }}>
        <h2 style={{ margin: 0, fontSize: 20 }}>Sample policies and standards</h2>
      ...
      <section style={{ border: "1px solid #222", borderRadius: 12, padding: 16 }}>
        <h2 style={{ margin: 0, fontSize: 20 }}>Codes of Practice and official guidance</h2>
        <ul style={{ padding: 0, listStyle: "none", marginTop: 8 }}>
          {codeLinks.map((c, i) => (
            <li key={i} style={{ border: "1px solid #222", borderRadius: 10, padding: 12, marginTop: 8 }}>

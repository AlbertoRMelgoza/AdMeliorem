    ...
    <main style={{ maxWidth: 960, margin: "0 auto", padding: "24px 16px" }}>
      ...
      >
        ...
        <p style={{ marginTop: 8, fontSize: 14 }}>
          Key standards:{" "}
          <Link href="https://www.iso.org/standard/64283.html" target="_blank" style={linkStyle}>
            ISO 45003
          </Link>
          ,{" "}
          <Link
      ...
      {/* Paid templates (no links/buttons) */}
      <section
        style={{
          border: "1px solid #222",
          borderRadius: 12,
      ...
      {/* Codes of Practice — links in yellow */}
        ...
        <ul style={{ display: "grid", gap: 8, padding: 0, listStyle: "none" }}>
          {codeLinks.map((c) => (
            <li key={c.href} style={{ border: "1px solid #222", borderRadius: 10, padding: 12 }}>
              <Link href={c.href} target="_blank" rel="noopener noreferrer" style={linkStyle}>
                {c.name}
              </Link>
            </li>
          ))}

...
export default function PrinciplesPage() {
  ...
  const section: CSSProperties = { background: "#111", border: "1px solid #222", borderRadius: 12, padding: 16, marginTop: 20 };
  const listHead: CSSProperties = { marginTop: 0 };
  const linklike: CSSProperties = { color: "#f1c40f", textDecoration: "none", fontWeight: 700 };

  // Small accent image styling
  const accentWrap: CSSProperties = {
    borderRadius: 12,
    overflow: "hidden",
    maxWidth: 360,
    width: "100%",
  ...
  // Two-column content grid that gracefully collapses on mobile
  ...
  return (
    <main style={wrap} id="top">
      <h1 style={{ marginTop: 0 }}>Principles</h1>
      <p>These statements set out how Ad Meliorem operates — with fairness, integrity, and respect for people and Country.</p>
      ...
      <section id="conduct" style={section}>
        ...
        {/* Smaller image placed beside the intro on wide screens */}
        <div style={contentGrid}>
          <div>
            <h3 style={{ marginTop: 12 }}>Introduction</h3>
            <p>
              As the sole owner and operator of Ad Meliorem, I hold myself to the highest standards of integrity, creativity,
              and fairness. This Code of Conduct articulates the values and commitments that guide every decision and
              interaction in my business.
            </p>
            <p>My aim is not only to achieve success, but to do so in a way that respects people, society, and the environment.</p>
          ...
          {/* Accent image (small) — ensure /public/Images/ethics.jpg exists */}
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div style={accentWrap}>
              <Image
      ...
      <p style={{ marginTop: 20 }}>
        <a href="#top" style={linklike} aria-label="Back to top">Back to top ↑</a>
      </p>
    </main>
  );
}

...
export default function Home() {
  ...
  return (
    <main style={wrap}>
      ...
      {/* Hero with ONE photo + yellow CTA */}
      <section style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 24, alignItems: "center" }}>
        <div style={{ padding: 24, background: "#111", border: "1px solid #222", borderRadius: 12 }}>
          ...
          <p style={{ marginTop: 0 }}>
            I help organisations prevent sexual harassment, aggression, bullying, and procedural justice failures before they cause harm.
          </p>
          <p style={{ marginTop: 12 }}>
            <a
              ...
              style={{
                ...
                backgroundColor: "#f1c40f", color: "#000",
                padding: "10px 18px", borderRadius: 6, fontWeight: 600, textDecoration: "none",
              }}
            >
              Contact me →
            </a>
        ...
        <div>
          <Image
            src="/images/hero-here-to-help.jpg"   // <-- IMPORTANT: /images/ path
      ...
      {/* Flagship Programs (™) */}
      <section>
        <h2 style={{ marginTop: 32 }}>My Programs &amp; Services</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
          <a href="/products/procedural-justice-framework" style={{ color: "inherit", textDecoration: "none" }}>
            <div style={card}>
              ...
              <p style={{ margin: 0 }}>Toolkit + guidance for complaint handling &amp; investigations. Fairness, transparency, defensibility.</p>
            </div>
          </a>
          <a href="/products/culture-risk-diagnostic" style={{ color: "inherit", textDecoration: "none" }}>
            <div style={card}>
              ...
              <p style={{ margin: 0 }}>Validated tools (COPSOQ, SEQ, etc.) to map hotspots and deliver Key Culture Risk Indicators.</p>
            </div>
          </a>
          <a href="/products/shsarc" style={{ color: "inherit", textDecoration: "none" }}>
            <div style={card}>
              ...
              <p style={{ margin: 0 }}>3-day, 11-module program focused on prevention, indicators, and defensible controls.</p>
            </div>
          </a>
          <a href="/products/rcabh" style={{ color: "inherit", textDecoration: "none" }}>
            <div style={card}>
              ...
              <p style={{ margin: 0 }}>4-day, 13-module program delivering practical, regulator-ready prevention measures.</p>
            </div>
          </a>
        </div>
      </section>
